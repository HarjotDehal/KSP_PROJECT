...
const rowss =[
...

    {
        ...
        name: "Tractor Trailer Wash",
        amount: totalTractorTrailerWash,
      },
      {
        id: 3,

        name: "IFTA Admin Fee",
        amount: totalIftaAdminFee,
      },
      {
        id: 4,
      ...
      },
      {
        ...
        name: "Occupational Insurance",
        amount: totalOccupationalInsurance,
      },
      {
        id: 6,
      ...
      },
      {
        ...
        name: "Inspection",
        amount: totalInspection,
      },
      {
        id: 8,

        name: "Yard Payment",
        amount: totalYardPayment,
      },
      {
        id: 9,

        name: "Repair Maintanence",
        amount: totalRepairMaintanence,
      },
      {
        id: 10,

        name: "Pay Deposit Fee",
        amount: totalPayDepositFee,
      },
      {
        id: 11,

        name: "Truck Payment",
        amount: totalTruckPayment,
      },
      {
        id: 12,
       
        name: "Trailer Payment",
        amount: totalTrailerPayment,
      },
      {
        id: 13,

        name: "Authority Insurance",
        amount: totalAuthorityInsurance,
      },
      {
        id: 14,
      ...
      },
      {
        ...
        name: "Base Plate",
        amount: totalBasePlate,
      },
      {
        id: 16,

        name: "Trailer Plate",
        amount: totalTrailerPlate,
      },
      {
        id: 17,

        name: "Permits And Drug Testing",
        amount: totalPermitsAndDrugTesting,
      },
      {
        id: 18,
        name: "Heavy Vehicle Use Tax",
        amount: totalHeavyVehicleUseTax,
      },
      {
        id: 19,
        name: "Lumper Fee",
        amount: totalLumperFee,
      },
      {
        id: 20,
        name: "Cat Scales",
        amount: totalCatScales,
      },
      {
        id: 21,
        name: "EZPass",
      ...
      {
        id: 24,
        name: "Tickets And Citations",
        amount: totalTicketsAndCitations,
      },
      {
        id: 25,
        name: "SFI Truck Returns",
        amount: totalSFITruckReturns,
      },
      {
        id: 26,
        name: "Other Expenses",
  ...
  return (
    <Box m="1.5rem 2.5rem">
      <Header title="Expense Overview" subtitle="View your Total Expenses per Category" />
...
<div style={{ textAlign: "center" }}>
      ...
      >
        ...
        //   rows={(data && data.transactions) || []}
          rows={rowss} // Render only the total row
          columns={columns}
          rowCount={(2) || 0}
        //   getRowHeight={getRowHeight}
          ...
          page={1}
          pageSize={1}
          getRowStyle={(params) => ({ fontSize: "30px" })}
